...
?>
    ...
    <script>function preview(){var src = document.getElementById('pic').value;
      ...
      <input type='text' name = 'id' value='<?php echo "ms_" . $char . time(); ?>' disabled>
      ...
      <input type='number' name='size' min='0' max='1000' id='size' placeholder='Product screen size' required>
      <input type='text' value='Inch' disabled>
        
      <label for='capacity'>Storage capacity: <b class='required'>*</b></label>
      <input type='number' name='capacity' min='0' id='capacity' placeholder='Product storage capacity' required>
      <input type='text' value='GB' disabled>
        
      <label for='rate'>Users rate: </label>
      <input type='number' name='rate' min='0' max='5' id='rate' value='3' disabled>
